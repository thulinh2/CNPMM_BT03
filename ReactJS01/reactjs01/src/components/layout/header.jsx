            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <Link to="/" className="text-2xl text-[30px] font-extrabold text-pink-600 flex items-center gap-2 hover:text-pink-700 transition-colors">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        >
                            <div className="relative">
                                ...
                                <span className="absolute text-[20px] -top-1.5 -right-2 bg-red-500 text-white font-bold px-1.5 py-0.5 rounded-full border border-white"></span>
                            </div>
                            Giỏ Hàng
                        </NavLink>
                            ...
                            <div className="relative border-l border-gray-200 pl-6" ref={dropdownRef}>
                                ...
                                >
                                    ...
                                    <div className="text-left hidden sm:block">
                                        <p className="text-[18px] text-gray-500 font-medium leading-none mb-1">Xin chào </p>
                                        <p className="text-[20px] text-gray-800 font-bold leading-none">{auth?.user?.name || auth?.user?.email || "Bạn"}</p>
                                    </div>
                                ...
                                {isDropdownOpen && (
                                    <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 overflow-hidden transform opacity-100 scale-100 transition-all duration-200">
                                        <Link 
                                            ...
                                            className="flex items-center gap-3 px-4 py-3 text-[18px] text-gray-700 hover:bg-pink-50 hover:text-pink-600 transition-colors"
                                        >
                                        ...
                                        <button 
                                            ...
                                            className="w-full text-left flex items-center gap-3 px-4 py-3 text-[18px] text-red-600 hover:bg-red-50 transition-colors font-medium"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
